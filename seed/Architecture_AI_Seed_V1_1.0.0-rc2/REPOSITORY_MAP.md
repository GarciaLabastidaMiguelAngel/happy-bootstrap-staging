...
Current rc2 navigation/control delta: [HAPPY-KNOW-90](knowledge/90_POST_RC1_RECONCILIATION.md). The workbook remains the rc1 historical snapshot; this additive register owns rc2 changes. Current validation: `evidence/seed-rc2-validation.json`. Prior reports remain historical, not rc2 test results.
