...
For rc2, load [projection/governance reconciliation](knowledge/90_POST_RC1_RECONCILIATION.md). Graph model is not Graph technology; complementary Graph/RAG context is source-snapshot aware. Governance/control/diagnostics clarify value without replacing the North Star. Recent artifact ecosystem is user-reported, not verified. Candidate technologies remain unadopted.
